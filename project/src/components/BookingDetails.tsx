      ...
      <CardContent className="space-y-6">
        ...
        {state.selectedDate && state.selectedTime && (
          <div className="space-y-2">
            <h3 className="text-lg font-semibold">Termin</h3>
            <div className="space-y-2">
        ...
        {state.selectedPackage && (
          <div className="space-y-2">
            <h3 className="text-lg font-semibold">Gewähltes Paket</h3>
            <div className="p-4 bg-accent/50 rounded-lg space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium">CHF {state.selectedPackage.price.toFixed(2)}</span>
              </div>
              {state.selectedPackage.services.length > 0 && (
                <ul className="mt-2 space-y-1">
                  {state.selectedPackage.services.map(service => (
                    <li key={service.id} className="flex justify-between text-muted-foreground">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">1x CHF {product.price.toFixed(2)}</p>
                    </div>
                  </div>
